...
public:
	...
	PitchDetectorYin (int sampleRate, unsigned int bufferSize) : yin (1, bufferSize), bufferSize (bufferSize), sampleRate(sampleRate), tolerence (0.15),
	deltaWasNegative (false)
	{
	}

	PitchDetectorYin (unsigned int bufferSize) : yin (1, bufferSize), bufferSize (bufferSize), sampleRate(44100), tolerence (0.15),
	deltaWasNegative (false)
	{
	}
